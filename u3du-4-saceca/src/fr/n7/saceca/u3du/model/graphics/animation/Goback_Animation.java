 ...
 */
public class Goback_Animation extends Animation {
	 ...
	 *            the object id
	 */
	public Goback_Animation(long objectId) {
		super(objectId);
	}
	...
	public void execute() {
		...
		float orientation = graphicalAgent.getOrientation();
		graphicalAgent.setYPosition(graphicalAgent.getYPosition() + 1);
		if (orientation > 0) {
			graphicalAgent.setXPosition(graphicalAgent.getXPosition() - 2);
		} else {
			graphicalAgent.setXPosition(graphicalAgent.getXPosition() + 2);
		}
