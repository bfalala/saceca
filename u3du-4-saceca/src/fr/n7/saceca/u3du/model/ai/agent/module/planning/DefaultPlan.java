...
/**
 * A plan implemented using a LinkedList.
 */
public final class DefaultPlan implements Plan {
	...
	@Override
	public DefaultPlan cons(PlanElement planElement) {
		((LinkedList<PlanElement>) this.backingCollection).addFirst(planElement);
		return this;
	}
	
	@Override
	public DefaultPlan append(PlanElement planElement) {
