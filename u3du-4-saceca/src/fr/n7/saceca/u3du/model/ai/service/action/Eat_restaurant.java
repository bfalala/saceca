 ...
 */
public class Eat_restaurant extends DoSomethingInABuildingAction {
	...
	public int getDuration(WorldObject provider, WorldObject consumer, Map<String, Object> params, Boolean anticipation)
		...
		return (int) (consumer.getPropertiesContainer().getInt("c_Restaurant_mealDuration") * (1 + percentVariation));
