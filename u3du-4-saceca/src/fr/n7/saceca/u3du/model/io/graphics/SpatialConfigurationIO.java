...
/**
 * A class to handle Spatial configuration IO.
 * 
 * @author Sylvain Cambon
 */
public class SpatialConfigurationIO extends XStreamIO<SpatialConfiguration> {
	...
	protected void configureIfNecessary(XStream xStream) {
		if (!configured) {
			xStream.processAnnotations(SpatialConfiguration.class);
			xStream.registerConverter(new SpatialConfigurationConverter());
			configured = true;
		}
	}
