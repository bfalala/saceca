...
/**
 * A class to handle Box configuration IO.
 * 
 * @author Sylvain Cambon
 */
public class BoxConfigurationIO extends XStreamIO<BoxConfiguration> {
	...
	protected void configureIfNecessary(XStream xStream) {
		if (!configured) {
			xStream.processAnnotations(BoxConfiguration.class);
			xStream.registerConverter(new BoxConfigurationConverter());
			configured = true;
		}
	}
