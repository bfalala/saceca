 ...
 */
public class ActionRepositoryLoader extends ClassRepositoryLoader<Action> {
	
	@Override
	protected String getRepositoryName() {
		return Action.class.getSimpleName() + " Repository";
	}
	
	@Override
	protected Class<Action> getTargetClassType() {
		return Action.class;
	}
}
