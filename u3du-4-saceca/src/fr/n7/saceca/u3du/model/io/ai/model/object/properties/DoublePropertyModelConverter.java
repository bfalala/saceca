...
/**
 * A class to convert double property model.
 * 
 * @author Sylvain Cambon
 */
public class DoublePropertyModelConverter extends NumericPropertyModelConverter {

    @SuppressWarnings("rawtypes")
    @Override
    public boolean canConvert(Class other) {
        return DoublePropertyModel.class.equals(other);
    }
