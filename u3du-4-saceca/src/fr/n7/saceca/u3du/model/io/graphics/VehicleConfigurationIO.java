...
/**
 * A class to handle Vehicle configuration IO.
 * 
 * @author Sylvain Cambon
 */
public class VehicleConfigurationIO extends XStreamIO<VehicleConfiguration> {
	...
	protected void configureIfNecessary(XStream xStream) {
		if (!configured) {
			xStream.processAnnotations(VehicleConfiguration.class);
			xStream.registerConverter(new VehicleConfigurationConverter());
			configured = true;
		}
	}
