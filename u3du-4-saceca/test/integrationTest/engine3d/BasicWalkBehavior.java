 ...
 */
public class BasicWalkBehavior extends DefaultBehavior {
	...
	public void behave() {
		if (this.object.getAnimation() != null) {
			...
			Animation a = new MoveHumanAnimation(this.object.getId(), place);
	...
	public String getStorageLabel() {
		return BasicWalkBehavior.class.getCanonicalName();
	}
