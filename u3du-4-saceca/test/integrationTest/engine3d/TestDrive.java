...
public class TestDrive {
	...
	private static final String INSTANCES_PATH = "data/ai/instances/integration tests/test drive";
	...
	public static void main(String[] args) throws SacecaStrictException {
		...
		WorldObject car = ai.getWorld().getWorldObjects().get(0L);
		Behavior b = new BasicDriveBehavior();
		b.init(car);
		car.setBehavior(b);
