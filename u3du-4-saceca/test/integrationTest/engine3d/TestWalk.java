...
public class TestWalk {
	...
	private static final String INSTANCES_PATH = "data/ai/instances/integration tests/test walk";
	...
	public static void main(String[] args) throws SacecaStrictException {
		...
		WorldObject smith = ai.getWorld().getWorldObjects().get(0L);
		Behavior b = new BasicWalkBehavior();
		b.init(smith);
		smith.setBehavior(b);
