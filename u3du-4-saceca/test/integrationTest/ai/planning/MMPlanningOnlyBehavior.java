...
public class MMPlanningOnlyBehavior extends DefaultBehavior {
	
	@Override
	public String getStorageLabel() {
		return MMPlanningOnlyBehavior.class.getCanonicalName();
	}
	...
	public void init(WorldObject object) {
		...
		// final ReasoningModule mmReasoningModule = new MMReasoningModule(agent);
		// agent.setMmReasoningModule(mmReasoningModule);
		
		final PlanningModule planningModule = new MatrixMethodPlanningModule(agent);
