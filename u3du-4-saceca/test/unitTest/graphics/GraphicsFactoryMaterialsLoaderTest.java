...
public class GraphicsFactoryMaterialsLoaderTest {
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println(materials.getAgentConfigurationRepository());
		System.out.println();
		System.out.println(materials.getBoxConfigurationRepository());
		System.out.println();
		System.out.println(materials.getVehicleConfigurationRepository());
	}
}
